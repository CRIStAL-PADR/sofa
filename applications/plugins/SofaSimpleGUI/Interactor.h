...
{
protected:
    sofa::core::sptr<sofa::simulation::Node> _interactionNode;  ///< Scene node used to implement this
...
public:
    ...
    sofa::core::sptr<sofa::simulation::Node> getNode() { return _interactionNode; }
