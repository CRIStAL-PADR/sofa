...
//        cerr<<"CompliantImplicitSolver_test, new velocities after backward integration: " << v2.transpose() << endl;
    ...
    void testEmptyMState( bool debug )
    {
        ...
        sofa::core::sptr<sofa::simulation::Node> mappedComplianceNode = root->createChild("mappedComplianceNode");
        ...
        sofa::core::sptr<sofa::simulation::Node> mappedStiffnessNode = root->createChild("mappedStiffnessNode");
