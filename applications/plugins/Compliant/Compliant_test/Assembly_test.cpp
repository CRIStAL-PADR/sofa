...
struct Assembly_test : public CompliantSolver_test
{
    ...
    static SparseMatrix getAssembledImplicitMatrix( sofa::core::sptr<sofa::simulation::Node> node, const core::MechanicalParams* mparams )
    {
    ...
    /// @warning the scene must be initialized
    static SparseMatrix getAssembledMassMatrix( sofa::core::sptr<sofa::simulation::Node> node, core::MechanicalParams mparams=*core::MechanicalParams::defaultInstance() )
    {
    ...
    /// @warning the scene must be initialized
    static SparseMatrix getAssembledStiffnessMatrix( sofa::core::sptr<sofa::simulation::Node> node, core::MechanicalParams mparams=*core::MechanicalParams::defaultInstance() )
    {
...
//        root->addObject( linearSolver);
        ...
        // The string
        sofa::core::sptr<sofa::simulation::Node>   string1 = createCompliantString( root, Vec3(0,0,0), Vec3(1,0,0), n, 1.0*n, 0. );
    ...
    void testConstrainedHardString( unsigned n )
    {
        ...
        sofa::core::sptr<sofa::simulation::Node>   string1 = createCompliantString( root, startPoint, Vec3(1,0,0), n, 1.0*n, 0. );
        ...
        sofa::core::sptr<sofa::simulation::Node> fixNode = string1->createChild(nodeName + "Node");
    ...
    void testExternallyConstrainedHardString( unsigned n )
    {
        ...
        // ======== object out of scope
        sofa::core::sptr<sofa::simulation::Node>  outOfScope = root->createChild("outOfScope");
        ...
        sofa::core::sptr<sofa::simulation::Node>  solverObject = root->createChild("solverObject");
...
//        complianceSolver->debug.setValue(true);
        ...
        // ========  string
        sofa::core::sptr<sofa::simulation::Node>  string1 = createCompliantString( solverObject, Vec3(0,0,0), Vec3(1,0,0), n, 1.0*n, 0 );


        // .=======  Node with multiple parents to create an interaction using a MultiMapping
        sofa::core::sptr<sofa::simulation::Node> commonChild = string1->createChild("commonChild");
        ...
        sofa::core::sptr<sofa::simulation::Node> extension_node = commonChild->createChild("ConnectionExtensionNode");
...
//                cerr<<"lambda = " << complianceSolver->getLambda().transpose() << endl;
    ...
    void testAttachedConnectedHardStrings( unsigned n )
    {
        ...
        // ========  strings
        sofa::core::sptr<sofa::simulation::Node>  string1 = createCompliantString( root, Vec3(0,0,0), Vec3(1,0,0), n, 1.0*n, 0 );
        sofa::core::sptr<sofa::simulation::Node>  string2 = createCompliantString( root, Vec3(2,0,0), Vec3(3,0,0), n, 1.0*n, 0 );
    ...
    */
    void testRigidConnectedToString( unsigned n )
    {
        ...
        // ========= The rigid object
        sofa::core::sptr<sofa::simulation::Node>  rigid = root->createChild("rigid");
        ...
        sofa::core::sptr<sofa::simulation::Node>  particleOnRigid = rigid->createChild("particleOnRigid");
        ...
        sofa::core::sptr<sofa::simulation::Node>  pointPair = particleOnRigid->createChild("pointPair");
        ...
        sofa::core::sptr<sofa::simulation::Node> extension = pointPair->createChild("extension");
    ...
    */
    void testDecomposedString( SReal stiffness = 1e4 )
    {
        ...
        // ========= DOF1
        sofa::core::sptr<sofa::simulation::Node>  node1 = root->createChild("node1");
        ...
        // ========= DOF2
        sofa::core::sptr<sofa::simulation::Node>  node2 = root->createChild("node2");
        ...
        // =========== common DOFs
        sofa::core::sptr<sofa::simulation::Node>  subset_node = node1->createChild( "SubsetNode");
        ...
        // ========= extension
        sofa::core::sptr<sofa::simulation::Node>  extension_node = subset_node->createChild( "ExtensionNode");
