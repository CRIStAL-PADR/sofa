...
protected:
    ...
    sofa::core::sptr<sofa::simulation::Node>  createCompliantString(sofa::core::sptr<sofa::simulation::Node> parent, Vec3 startPoint, Vec3 endPoint, unsigned numParticles, SReal totalMass, SReal complianceValue=0/*, SReal dampingRatio=0*/, bool isCompliant=true, SReal totalRestLength = -1 )
    {
        ...
        //--------
        sofa::core::sptr<sofa::simulation::Node>   string_node = parent->createChild(oss.str());
        ...
        //--------
        sofa::core::sptr<sofa::simulation::Node>  extension_node = string_node->createChild( oss.str()+"_ExtensionNode");
    ...
    {
        sofa::core::sptr<sofa::simulation::Node>   string_node; ///< root
        MechanicalObject3::SPtr DOF; ///< particle states
        UniformMass3::SPtr mass;

        sofa::core::sptr<sofa::simulation::Node>  extension_node;
        ...
        ParticleString(sofa::core::sptr<sofa::simulation::Node> parent, Vec3 startPoint, Vec3 endPoint, unsigned numParticles, SReal totalMass )
        {
        static unsigned numObject = 1;
        std::ostringstream oss;
        oss << "string_" << numObject++;
