...
struct DampedOscillator_test : public CompliantSolver_test
{
            ...
            )
    {
        ...
        // The oscillator
        sofa::core::sptr<sofa::simulation::Node>  oscillator = node->createChild("oscillator");
...
//    compliance->isCompliance.setValue(true);
    ...
    sofa::core::sptr<sofa::simulation::Node>  constraint = oscillator->createChild( "constraint" );
