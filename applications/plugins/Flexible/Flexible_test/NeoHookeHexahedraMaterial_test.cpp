...
struct NeoHookeHexahedraMaterial_test : public Sofa_test<typename Vec3Types::Real>
{
    ...
    ForceFieldSPtr addNeoHookeForceField(sofa::core::sptr<sofa::simulation::Node> node,
    ...
    ForceFieldSPtr addMooneyRivlinForceField(sofa::core::sptr<sofa::simulation::Node> node,
        double youngModulus,double poissonRatio)
    {
