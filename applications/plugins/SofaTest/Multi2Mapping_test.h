...
struct Multi2Mapping_test : public Sofa_test<typename _MultiMapping::Real>
{
    ...
    sofa::core::sptr<sofa::simulation::Node>  child; ///< Child node, created by setupScene
    sofa::core::sptr<sofa::simulation::Node>  parentsIn1, parentsIn2; ///< Parent nodes, created by setupScene
