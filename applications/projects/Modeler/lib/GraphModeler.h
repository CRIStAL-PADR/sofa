...
public:
    ...
    sofa::core::sptr<sofa::simulation::Node> setRoot(sofa::core::sptr<sofa::simulation::Node> node=NULL, bool saveHistory=true) {clearGraph(saveHistory); return addNode(NULL, node, saveHistory);}
    ...
    sofa::core::sptr<sofa::simulation::Node> loadNode(QTreeWidgetItem* item, std::string filename="", bool saveHistory=true);
    ...
    sofa::core::sptr<sofa::simulation::Node> buildNodeFromBaseElement(sofa::core::sptr<sofa::simulation::Node> node,xml::BaseElement *elem, bool saveHistory=false);
...
public slots:
    ...
    sofa::core::sptr<sofa::simulation::Node> loadNode();
    ...
    sofa::core::sptr<sofa::simulation::Node> loadNode(Node::SPtr, std::string, bool saveHistory=true);
...
protected:
    ...
    sofa::core::sptr<sofa::simulation::Node> addNode(sofa::core::sptr<sofa::simulation::Node> parent, sofa::core::sptr<sofa::simulation::Node> node=NULL, bool saveHistory=true);
    /// Insert a Component in the scene
    BaseObject::SPtr addComponent(sofa::core::sptr<sofa::simulation::Node> parent, const ClassEntry::SPtr entry, const std::string& templateName, bool saveHistory=true, bool displayWarning=true );
    ...
    sofa::core::sptr<sofa::simulation::Node> graphRoot; ///< root node of the graph (it is now necessary to hold a smart pointer to it in order to keep it from being deleted)
