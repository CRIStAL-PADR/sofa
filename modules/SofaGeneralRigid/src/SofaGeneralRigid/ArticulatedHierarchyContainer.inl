...
void ArticulatedHierarchyContainer::buildCenterArticulationsTree(sofa::helper::io::bvh::BVHJoint* bvhjoint, int id_buf, const char* name, simulation::Node* node)
{
    ...
    sofa::core::sptr<sofa::simulation::Node>  nodeOfArticulationCenters =node->createChild(str);
    ...
    sofa::core::sptr<sofa::simulation::Node>  nodeOfArticulations = nodeOfArticulationCenters->createChild("articulations");
...
void ArticulatedHierarchyContainer::init ()
{
    ...
    if (joint != nullptr)
    {
        sofa::core::sptr<sofa::simulation::Node>  articulationCenters = context->createChild("ArticulationCenters");
