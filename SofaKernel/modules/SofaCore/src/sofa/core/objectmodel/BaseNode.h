...
public:
    ...
    virtual bool addObject(sofa::core::sptr<BaseObject> obj) = 0;

    /// Remove a generic object
    virtual bool removeObject(sofa::core::sptr<BaseObject> obj) = 0;

    /// Move an object from a node to another node
    virtual void moveObject(sofa::core::sptr<BaseObject> obj) = 0;
...
protected:
    ...
    void setObjectContext(sofa::core::sptr<BaseObject> obj);

    /// Reset the context of an object
    void clearObjectContext(sofa::core::sptr<BaseObject> obj);
